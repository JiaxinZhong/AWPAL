...
function prs = PalCircSrc_SWE(pal, fp, varargin)
    ...
    ip.addParameter('l1_max', ceil(real(pal.ultra_low.num)*pal.src_ultra.radius*1.1));
    ip.addParameter('l2_max', ceil(real(pal.ultra_high.num)*pal.src_ultra.radius*1.09));
