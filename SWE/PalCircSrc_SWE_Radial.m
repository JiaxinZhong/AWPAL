...
function R = PalCircSrc_SWE_Radial(pal, r, la_max, l1_max, l2_max, varargin)
    ...
    if ip.is_farfield
        ...
        if ~isempty(r_origin)
            R(idx_origin, 1, 1, :, :, :) ...
                = PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, 0, a, 0, 'h') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, a, a+2, 0, 'h') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, a+2, a+5, 0, 'h') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, a+5, inf, 0, 'h');
        end
        ...
        if ~isempty(r_int)
            % R = PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, 0, a, r, 'j') ...
                ...
                % 'int_method', 'direct');
            R(idx_int, 1, 1, :, :, :) ...
                = PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, 0, r_int, r_int, 'j') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, r_int, a, r_int, 'h') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, a, a+2, r_int, 'h') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, a+2, a+5, r_int, 'h') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, a+5, inf, r_int, 'h');
        end
        % process exterior points
        if ~isempty(r_ext)
            R(idx_ext, 1, 1, :, :, :) ...
                = PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, 0, a, r_ext, 'j') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, a, r_ext, r_ext, 'j') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, r_ext, r_ext+2, r_ext, 'h') ...
                + PalCircSrc_SWE_RadialInt(pal, la, l1_max, l2_max, r_ext+2, r_ext+5, r_ext, 'h') ...
